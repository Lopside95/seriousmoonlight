...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col px-72 gap-52 py-24">
      ...
      <section>
        <ul className="text-[1.4rem] max-w-[1000px] leading-10 self-center flex flex-col gap-2 list-disc">
          <li>
      ...
      <section className="self-start">
        <h3>Let&apos;s Dance</h3>
        <p className="underline underline-offset-2 text-2xl font-light">
...
export const intro = (
  <h2 className=" leading-[3.2rem] text-center">
